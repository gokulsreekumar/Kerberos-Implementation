...
//        System.out.println(Arrays.toString(cipher.salt));
    ...
    public static EncryptionData getEncryptionUsingSecretKey(String plainText, byte[] keyBytes)
            throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException,
            NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException {
        ...
        return new EncryptionData(encrypt(SYMMETRIC_KEY_ALGORITHM, plainText, secretKey, ivParameterSpec), null, iv);
    }

    public static String getDecryptionUsingSecretKey(EncryptionData cipher, byte[] keyBytes)
            throws NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException,
            NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException {
        ...
        return decrypt(SYMMETRIC_KEY_ALGORITHM, cipher.cipherText, secretKey, new IvParameterSpec(cipher.iv));
    }
