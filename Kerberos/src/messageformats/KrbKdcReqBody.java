...
public class KrbKdcReqBody implements ImmutableKrbKdcReqBody {
    /*
    ...
    public KrbKdcReqBody(PrincipalName cname, PrincipalName sname, Optional<Timestamp> from, Timestamp till, int nonce, int etype) {
        this.cname = cname;
        this.sname = sname;
        this.from = from;
        this.till = till;
